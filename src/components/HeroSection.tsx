...
export const HeroSection = () => {
  ...
  const logoTransform = isScrolled ? 'scale(0.4) translate(-800px, -400px)' : 'translate(-50%, -50%) scale(1)';
  return <section className="relative min-h-screen flex flex-col items-center justify-center bg-gradient-hero overflow-hidden">
      ...
      {/* Main Logo */}
      <div className={`${isScrolled ? 'fixed top-8 left-8' : 'fixed top-1/2 left-1/2'} z-50 transition-all duration-700 ease-out ${isScrolled ? 'cursor-pointer' : ''}`} style={{
      ...
      behavior: 'smooth'
        ...
        <div className="relative">
          <img src={invokerLogo} alt="InvokerTech Logo" className="w-64 h-64 rounded-full magic-glow animate-pulse-glow" />
